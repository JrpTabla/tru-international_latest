...
@section('content')
    ...
    <link rel="stylesheet" href="{{ asset ('assets/css/maintenance/landing-section.css') }}">
            ...
            <div class="maintenance-landing-section-first-div row">
                <div class="maintenance-landing-section-first-content d-flex col-12">
                    <div class="m-auto">
                        <div class="maintenance-landing-section-first-content-img">
                            <img src="{{ asset ('assets/images/maintenance-images/landing-image.png') }}" alt="" style="width: 100%"/>
                        </div>
                    </div>
                </div>
                <div class="maintenance-landing-section-second-content d-flex col-12">
                    ...
                    <div class="email-div mx-auto">
                        <img class="my-auto" src="{{ asset ('assets/images/maintenance-images/mail-image.png') }}" alt="" width="48px" height="36px">
