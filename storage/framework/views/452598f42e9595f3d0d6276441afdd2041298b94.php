...
<body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        ...
        <div class="nav-menu">   
            <div class="search-div" >
                <img src="./images/circum_search.png" alt="" width="24px" height="24px">
        ...
        <div class="navbar-div">
            <ul class="navbar-nav d-flex navbar-link ms-auto">
                <li class="nav-item">
                    <a class="nav-h11" href="#">Rating</a>
                </li>
                <li class="nav-item">
                    <a class="nav-h11" href="#">CommuniTrade</a>
                </li>
                <li class="nav-item">
    ...
    <div class="main">
        ...
        <section id="landing-section" class="landing-section">
            ...
            <div class="landing-img-background m-auto" >
                    <img src="./images/hero_image_left.png" alt="" class=" background-img-left"/>
                    <img src="./images/hero_image_right.png" alt="" class="background-img-right"/>
            </div>
            ...
            <div class="lading-section-card-div mx-auto d-flex container-fluid" style="max-width: 1400px">
                ...
                <div class="card-div row" style="margin-top: 48px;margin-bottom: 52px;">
                    ...
                    <div class="col-4 px-3">
                        <div class="landing-card" style="min-height: 490px;border-radius: 48px;border: 2px solid #9AD9FF;background: #1681C2;background-image: url(./images/card-1.png);display: flex;mix-blend-mode: plus-darker;">
                            <div class="m-auto">
                                <div class="landing-card-title text-white text-center mx-auto my-5" style="max-width: 334px;">CommuniTrade</div>
                                <div class="landing-card-description text-white text-center" style="max-width: 366px;">Get up to 100% coverage of your trading losses through the Risk Protection Plan. Reassure to experience fair trading practices and have
                    ...
                    <!-- Second Card -->
                    <div class="col-4 px-3">
                        <div class="landing-card" style="min-height: 490px;border-radius: 48px;border: 2px solid #E7AA2D;background: #817B0D;background-image: url(./images/card-2.png);display: flex;mix-blend-mode: plus-darker;">
                            <div class="m-auto">
                                <div class="landing-card-title text-white text-center mx-auto my-5" style="max-width: 334px;">CommuniTrade</div>
                                <div class="landing-card-description text-white text-center" style="max-width: 366px;">Get up to 100% coverage of your trading losses through the Risk Protection Plan. Reassure to experience fair trading practices and have
                                    a guarantee to navigate your trading career confidently.</div>
                    ...
                    <!-- Third Card -->
                    <div class="col-4 px-3">
                        <div class="landing-card" style="min-height: 490px;border-radius: 48px;border: 2px solid #8ECB86;background: #569E4C;background-image: url(./images/card-3.png);display: flex;mix-blend-mode: plus-darker;">
                            <div class="m-auto" style="max-width: 339px;">
                                
                                <div class="landing-card-title text-white text-center mx-auto my-4" style="max-width: 334px;;">Profit-Sharing Program</div>
                                <div class="landing-card-description text-white text-center" style="max-width: 366px;">Get up to 100% coverage of your trading losses through the Risk Protection Plan. Reassure to experience fair trading practices and have
                                    a guarantee to navigate your trading career confidently.</div>
                            </div>
                        </div>
                ...
                <!-- Card Row -->
                <div class="card-div-2 justify-content-center" style="margin-top: 48px;margin-bottom: 52px;">
                    <!-- First Card -->
                    <div class="">
                        <div class="landing-card-sm-1">
                            <div>
                                <div class="landing-card-sm-title text-center">CommuniTrade</div>
                                <div class="landing-card-sm-content text-center">Get up to 100% coverage of your trading losses through the Risk Protection Plan. Reassure to experience fair trading practices and have a guarantee to navigate your trading career confidently.</div>
                            </div>
                        </div>
                    </div>
                    <div class="">
                        <div class="landing-card-sm-2">
                            <div>
                                <div class="landing-card-sm-title text-center">Risk Protection Program</div>
                                <div class="landing-card-sm-content text-center">Get up to 100% coverage of your trading losses through the Risk Protection Plan. Reassure to experience fair trading practices and have a guarantee to navigate your trading career confidently.</div>
                            </div>
                        </div>
                    </div>
                    <div class="">
                        <div class="landing-card-sm-3">
                            <div>
                                <div class="landing-card-sm-title text-center">CommuniTrade</div>
                                <div class="landing-card-sm-content text-center">Get up to 100% coverage of your trading losses through the Risk Protection Plan. Reassure to experience fair trading practices and have a guarantee to navigate your trading career confidently.</div>
                            </div>
        ...
        <!-- Third Section Start -->
        <section id="third-section" class="third-section" data-color="#9AD9FF" >

            <div class="second-img-background" style="min-width: 1920px;position: absolute;left:50%;
                transform: translate(-50%,-50%);">
                        <div class="third-section-ads-1"></div>
                        <div class="third-section-ads-2"></div>
                </div>
            ...
            <div class="container-fluid mx-auto">
                ...
                <div class="third-section-container row mx-auto">
                            ...
                            <div class="third-section-first-content d-flex col-12 col-xl-6 ">
                                <div class="m-auto">  
                                    <div class="third-section-first-content-title">
                                        <span>Protect</span> <br> your trading <br> account.
                                    </div>
                                    <div class="third-section-first-content-description">
                                        Get up to 100% coverage of your trading losses through the Risk Protection Plan. Reassure to experience fair trading practices and have a guarantee to navigate your trading career confidently.
                                    </div>
                                </div>
                            </div>
                            <div class="third-section-second-content d-flex col-12 col-xl-6">
                                <div class="m-auto">  
                                    <div class="third-section-first-content-img">
                                        <img src="./images/Third-section/card-1.png" alt="" style="width: 100%;">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="padding-gap col-12 col-xl-6">
                        <div class="third-section-second-div row ">
                            <div class="third-section-second-content d-flex col-12">
                                <div class="m-auto">  
                                    <div class="third-section-first-content-img">
                                        <img src="./images/Third-section/card-2.png" alt="" style="width: 100%;">
                                    </div>
                                </div>
                            </div>
                            <div class="third-section-first-content d-flex col-12">
                                <div class="m-auto">  
                                    <div class="third-section-first-content-title-2">
                                        <span>Engage</span> <br> to succeed.
                                    </div>
                                    <div class="third-section-first-content-description-2">
                    ...
                    <div class="padding-gap col-12 col-xl-6">
                        <div class="third-section-third-div-3 row ">
                            <div class="third-section-first-content d-flex col-12">
                                <div class="m-auto">  
                                    <div class="third-section-first-content-title-3">
                                        <span>Earn while</span>  <br> you’re at it.
                                    </div>
                
                                    <div class="third-section-first-content-description-3">
                                        Follow successful traders, share your insights and experiences, and receive advice on CommuniTrade, your dedicated channel for collaborative growth in the trading community.
                                    </div>
                                </div>
                            </div>
                            <div class="third-section-second-content d-flex col-12">
                                <div class="m-auto">  
                                    <div class="third-section-first-content-img">
                                        <img src="./images/Third-section/card-3.png" alt="" style="width: 100%;">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section id="fourth-section" class="fourth-section" data-color="#FFCA5D" >
            <div class="container-fluid">
                <div class="fourth-section-container row mx-auto">
                    <div class="padding-gap col-12">
                        <div class="fourth-section-first-div row">
                            <div class="fourth-section-first-content d-flex col-12 col-xl-6">
                                <div class="m-auto">  
                                    ...
                                    <div class="fourth-section-first-content-description">
                                        is a commitment to a transformative trading experience where every member is empowered to succeed.
                                    </div>
                                </div>
                            </div>
                            <div class="fourth-section-second-content d-flex col-12 col-xl-6">
                                <div class="m-auto">  
                                    <div class="fourth-section-first-content-img">
                                        <img src="./images/fourth-section/card-1.png" alt="" style="width: 100%;">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="padding-gap col-12 col-xl-6">
                        <div class="fourth-section-second-div row">
                            <div class="fourth-section-second-content d-flex col-12">
                                <div class="m-auto">  
                                    <div class="fourth-section-first-content-img">
                                        <img src="./images/fourth-section/card-2.png" alt="" style="width: 100%;">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="padding-gap col-12 col-xl-6">
                        <div class="fourth-section-third-div-3 row" style="position: relative;">
                            <div class="fourth-section-first-content d-flex col-12">
                                <div class="">  
                            ...
                            <img src="./images/fourth-section/card-3.png" alt="" style="position: absolute;left: 0;bottom: 0;padding: 0 !important;">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="fifth-section" class="fifth-section" data-color="#fff">
            <div class="container-fluid">
                <div class="fifth-section-container row mx-auto">
                    <div class="padding-gap col-12">
                        <div class="fifth-section-first-div row col-12">
                            <div class="fifth-section-first-content d-flex col-12 col-xl-6">
                                <div class="m-auto">  
                                    <div class="fifth-section-first-content-title">
                                        <span>Engage and <br> learn </span> together  <br> with others
                                    </div>
                                    <div class="fifth-section-first-content-description">
                                        CommuniTrade evolved the concept of social media into an indispensable reservoir of shared and collaborative wisdom.
                                    </div>
                                    <a class="fifth-section-first-content-button">Be part of the CommUNITRADE</a>
                                </div>
                            </div>
                            <div class="fifth-section-second-content d-flex col-12 col-xl-6">

                                <img class="circle-1" src="./images/fifth-section/circle-1.png">
                                <img class="circle-2" src="./images/fifth-section/circle-1.png">
                                <img class="circle-3" src="./images/fifth-section/circle-1.png">
                                <img class="circle-4" src="./images/fifth-section/circle-1.png">

                                <img class="image-1" src="./images/fifth-section/ava1.png" style="width: 168px;height: 168px;position: absolute;top: 50px;right: 50px;cursor: pointer;">
                                <img class="image-2" src="./images/fifth-section/ava2.png" style="width: 103px;height: 103px;position: absolute;bottom: 25px;right: 0px;cursor: pointer;">
                                <img class="image-3" src="./images/fifth-section/Vector.png" style="width: 81px;height: 81px;position: absolute;bottom: 15px;right: 200px;cursor: pointer;">
                                <img class="image-4" src="./images/fifth-section/ava4.png" style="width: 185px;height: 185px;position: absolute;bottom: 15px;left: 20px;cursor: pointer;">
                                <img class="image-5" src="./images/fifth-section/ava5.png" style="width: 65px;height: 65px;position: absolute;top: 100px;left: 10px;cursor: pointer;">
                                <img class="image-6" src="./images/fifth-section/ava6.png" style="width: 132px;height: 132px;position: absolute;top: 75px;left: 125px;cursor: pointer;">


                                <!-- <div class="m-auto" style="z-index: 1;">  --> 
                                    <div class="fifth-section-second-content-comment d-flex m-auto">
                                        <div class="fifth-section-second-content-profile">
                                            <img src="./images/fifth-section/profile.png">
                                        </div>
            ...
            <!-- Second Section Ads Division -->
            <div class="fifth-section-advertisment-container container-fluid mx-auto"></div>
        </section>
        <!-- Fifth Section End -->

        <!-- Sixth Section Start -->
        <section id="sixth-section" class="sixth-section" data-color="#8ECB86">
            <div class="container-fluid">
                <div class="sixth-section-container row mx-auto">
                    <div class="padding-gap col-12">
                        <div class="sixth-section-first-div row">
                            <div class="sixth-section-first-content d-flex col-12 col-xl-6">
                                <div class="m-auto">  
                                    <div class="sixth-section-first-content-title">
                                        Let’s Forge <span>a <br>better trading <br>world</span>
                                    </div>
                                    <div class="sixth-section-first-content-description">
                                        70% of forex traders incur losses each quarter, and the vast majority deplete their investment capital within just a year.
                                    </div>
                                </div>
                            </div>
                            <div class="sixth-section-second-content d-flex col-12 col-xl-6">
                                <div class="m-auto">  
                                    <div class="sixth-section-first-content-img">
                                        <img src="./images/sixth-section/card-1.png" alt="" style="width: 100%;">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="padding-gap col-12 col-xl-6">
                        <div class="sixth-section-second-div row">
                            <div class="sixth-section-second-content d-flex col-12">
                                <div class="m-auto">  
                                    <div class="sixth-section-first-content-img">
                                        <img src="./images/sixth-section/card-2.png" alt="" style="width: 100%;">
                                    </div>
                                </div>
                            </div>
                            <div class="sixth-section-first-content d-flex col-12">
                                <div class="m-auto">  
                                    <div class="sixth-section-first-content-title-2">
                                        Trade, <br> <span>Protected</span>
                                    </div>
                                    <div class="sixth-section-first-content-description-2">
                                        Eliminate doubts about your broker or exchange and relieve anxiety from being cheated on. Focus on the opportunities and growth of your investments.
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="padding-gap col-12 col-xl-6">
                        <div class="sixth-section-third-div-3 row justify-content-center" style="position: relative;">
                            <div class="sixth-section-first-content d-flex col-12">
                                <div class="">  
                            ...
                            <img class="sixth-section-first-content-phone" src="./images/sixth-section/card-3.png" alt="" style="position: absolute;bottom: 0;padding: 0 !important;max-width: 354px;">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="seventh-section" class="seventh-section" data-color="#E6E7E7">
            <div class="container-fluid">
                <div class="seventh-section-container row mx-auto">
                    <div class="padding-gap col-12">
                        <div class="seventh-section-first-div row">
                            <div class="seventh-section-first-content d-flex col-12 col-xl-4">
                                <div class="me-auto my-auto">  
                                    <div class="seventh-section-first-content-title">
                                        What do <br> you need <br> to know
                                    </div>
                                    <div class="seventh-section-first-content-description">
                                        Stay updated, learn from the experts.
                                    </div>
                                    <a class="seventh-section-first-content-button">More news</a>
                                </div>
                            </div>
                            <div class="seventh-section-second-content d-flex col-12 col-xl-8 row" >
                                <div class="seventh-section-second-card-div-1 col-6 p-2" >
                                    <div class="seventh-section-second-card-1">
                                        <img class="seventh-section-second-card-main-img" src="./images/seventh-section/card-1.png">
                                        ...
                                        <div class="seventh-section-second-time">
                                            <img src="./images/seventh-section/lets-icons_time-light.png" alt="">
                                            <div class="seventh-section-second-date">November 29, 2023</div>
                                        </div>
                                    </div>
                                    <div class="seventh-section-second-card-1">
                                        <img class="seventh-section-second-card-main-img" src="./images/seventh-section/card-2.png">
                                        <div class="seventh-section-second-title">Tag title</div>
                                        <div class="seventh-section-second-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod...</div>
                                        <div class="seventh-section-second-time">
                                            <img src="./images/seventh-section/lets-icons_time-light.png" alt="">
                                ...
                                <div class="seventh-section-second-card-div-2 col-6 p-2">
                                    <div class="seventh-section-second-card-2">
                                        <img class="seventh-section-second-card-main-img" src="./images/seventh-section/card-3.png">
                                        <div class="seventh-section-second-title">Tag title</div>
                                        <div class="seventh-section-second-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod...</div>
                                        <div class="seventh-section-second-time">
                                            <img src="./images/seventh-section/lets-icons_time-light.png" alt="">
                                    ...
                                    <div class="seventh-section-second-card-2">
                                        <img class="seventh-section-second-card-main-img" src="./images/seventh-section/card-4.png">
                                        <div class="seventh-section-second-title">Tag title</div>
                                        <div class="seventh-section-second-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod...</div>
                                        <div class="seventh-section-second-time">
                                            <img src="./images/seventh-section/lets-icons_time-light.png" alt="">
                            ...
                            <a class="seventh-section-first-content-button-2">More news</a>
                        </div>
                    </div>  
                </div>
            </div>
        ...
        <!-- Eigth Section Start -->
        <section id="eigth-section" class="eigth-section" style="position: relative;" data-color="#131313">
            <div class="container-fluid">
                <div class="eigth-section-container row mx-auto">
                    <div class="padding-gap col-12">
                        <div class="eigth-section-first-div row">
                            <div class="eigth-section-first-content d-flex col-12 col-xl-7">
                                <div class="me-auto ">  
                            ...
                            <div class="eigth-section-second-content d-flex col-12 col-xl-5">
                                <img src="./images/eigth-section/card-1.png" alt="" class="eigth-section-second-content-img-1">
                                <img src="./images/eigth-section/card-2.png" alt="" class="eigth-section-second-content-img-2">
                                <img src="./images/eigth-section/card-3.png" alt="" class="eigth-section-second-content-img-3">
                            </div>
                            ...
                            <div class="eigth-section-third-content col-12 col-xl-7">
                                <div class="m-auto">  
                                    <a class="eigth-section-third-content-button">Be a TRU member</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="eigth-section-scroll-section">
                ...
                <a class="eigth-section-fourth-content-button">Be a TRU member</a>
    ...
    <script src="<?php echo e(asset ('assets/js/bootstrap.js')); ?>" integrity="sha384-C6RzsynM9kWDrMNeT87bh95OGNyZPhcTNXj1NW7RuBCsyN/o0jlpcV8Qyq46cDfL" crossorigin="anonymous"></script>


</body>

</html><?php /**PATH C:\Users\SysplexUser\Desktop\laravel\example-app\resources\views/welcome.blade.php ENDPATH**/ ?>