...
<div class="main">
        ...
        <section id="landing-section" class="landing-section">
            ...
            <div class="landing-img-background m-auto" >
                    <img src="<?php echo e(asset ('assets/images/Home-images/hero_image_left.png')); ?>" alt="" class=" background-img-left"/>
                    <img src="<?php echo e(asset ('assets/images/Home-images/hero_image_right.png')); ?>" alt="" class="background-img-right"/>
            </div>
            ...
            <div class="lading-section-card-div mx-auto d-flex container-fluid" style="max-width: 1400px">
                ...
                <div class="card-div row" style="margin-top: 48px;margin-bottom: 52px;">
                    ...
                    <div class="col-4 px-3">
                        <div class="landing-card" style="min-height: 490px;border-radius: 48px;border: 2px solid #9AD9FF;background: #1681C2;background-image: url(<?php echo e(asset ('assets/images/Home-images/card-1.png')); ?>);display: flex;mix-blend-mode: plus-darker;">
                            <div class="m-auto">
                    ...
                    <!-- Second Card -->
                    <div class="col-4 px-3">
                        <div class="landing-card" style="min-height: 490px;border-radius: 48px;border: 2px solid #E7AA2D;background: #817B0D;background-image: url(<?php echo e(asset ('assets/images/Home-images/card-2.png')); ?>);display: flex;mix-blend-mode: plus-darker;">
                            <div class="m-auto">
                                <div class="landing-card-title text-white text-center mx-auto my-5" style="max-width: 334px;">CommuniTrade</div>
                                <div class="landing-card-description text-white text-center" style="max-width: 366px;">Get up to 100% coverage of your trading losses through the Risk Protection Plan. Reassure to experience fair trading practices and have
                                    a guarantee to navigate your trading career confidently.</div>
                    ...
                    <!-- Third Card -->
                    <div class="col-4 px-3">
                        <div class="landing-card" style="min-height: 490px;border-radius: 48px;border: 2px solid #8ECB86;background: #569E4C;background-image: url(<?php echo e(asset ('assets/images/Home-images/card-3.png')); ?>);display: flex;mix-blend-mode: plus-darker;">
                    ...
                    <div class="padding-gap col-12 col-xl-6">
                        <div class="third-section-second-div row ">
                            <div class="third-section-second-content d-flex col-12">
                                <div class="m-auto">  
                                    <div class="third-section-first-content-img">
                                        <img src="<?php echo e(asset ('assets/images/Home-images/Third-section/card-2.png')); ?>" alt="" style="width: 100%;">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="padding-gap col-12 col-xl-6">
                        <div class="third-section-third-div-3 row ">
                            ...
                            <div class="third-section-second-content d-flex col-12">
                                <div class="m-auto">  
                                    <div class="third-section-first-content-img">
                                        <img src="<?php echo e(asset ('assets/images/Home-images/Third-section/card-3.png')); ?>" alt="" style="width: 100%;">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="fourth-section-container row mx-auto">
                    ...
                    <div class="padding-gap col-12 col-xl-6">
                        <div class="fourth-section-third-div-3 row" style="position: relative;">
                            ...
                            <img src="<?php echo e(asset ('assets/images/Home-images/fourth-section/card-3.png')); ?>" alt="" style="position: absolute;left: 0;bottom: 0;padding: 0 !important;">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="padding-gap col-12">
                        <div class="fifth-section-first-div row col-12">
                            ...
                            <div class="fifth-section-second-content d-flex col-12 col-xl-6">
                                ...
                                <img class="circle-1" src="<?php echo e(asset ('assets/images/Home-images/fifth-section/circle-1.png')); ?>">
                                <img class="circle-2" src="<?php echo e(asset ('assets/images/Home-images/fifth-section/circle-1.png')); ?>">
                                <img class="circle-3" src="<?php echo e(asset ('assets/images/Home-images/fifth-section/circle-1.png')); ?>">
                                <img class="circle-4" src="<?php echo e(asset ('assets/images/Home-images/fifth-section/circle-1.png')); ?>">

                                <img class="image-1" src="<?php echo e(asset ('assets/images/Home-images/fifth-section/ava1.png')); ?>" style="width: 168px;height: 168px;position: absolute;top: 50px;right: 50px;cursor: pointer;">
                                <img class="image-2" src="<?php echo e(asset ('assets/images/Home-images/fifth-section/ava2.png ')); ?>" style="width: 103px;height: 103px;position: absolute;bottom: 25px;right: 0px;cursor: pointer;">
                                <img class="image-3" src="<?php echo e(asset ('assets/images/Home-images/fifth-section/Vector.png ')); ?>" style="width: 81px;height: 81px;position: absolute;bottom: 15px;right: 200px;cursor: pointer;">
                                <img class="image-4" src="<?php echo e(asset ('assets/images/Home-images/fifth-section/ava4.png ')); ?>" style="width: 185px;height: 185px;position: absolute;bottom: 15px;left: 20px;cursor: pointer;">
                                <img class="image-5" src="<?php echo e(asset ('assets/images/Home-images/fifth-section/ava5.png ')); ?>" style="width: 65px;height: 65px;position: absolute;top: 100px;left: 10px;cursor: pointer;">
                                <img class="image-6" src="<?php echo e(asset ('assets/images/Home-images/fifth-section/ava6.png ')); ?>" style="width: 132px;height: 132px;position: absolute;top: 75px;left: 125px;cursor: pointer;">
                ...
                <div class="sixth-section-container row mx-auto">
                    ...
                    <div class="padding-gap col-12 col-xl-6">
                        <div class="sixth-section-second-div row">
                            <div class="sixth-section-second-content d-flex col-12">
                                <div class="m-auto">  
                                    <div class="sixth-section-first-content-img">
                                        <img src="<?php echo e(asset ('assets/images/Home-images/sixth-section/card-2.png ')); ?>" alt="" style="width: 100%;">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="padding-gap col-12 col-xl-6">
                        <div class="sixth-section-third-div-3 row justify-content-center" style="position: relative;">
                            ...
                            <img class="sixth-section-first-content-phone" src="<?php echo e(asset ('assets/images/Home-images/sixth-section/card-3.png ')); ?>" alt="" style="position: absolute;bottom: 0;padding: 0 !important;max-width: 354px;">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="padding-gap col-12">
                        <div class="eigth-section-first-div row">
                            ...
                            <div class="eigth-section-second-content d-flex col-12 col-xl-5">
                                <img src="<?php echo e(asset ('assets/images/Home-images/eigth-section/card-1.png  ')); ?>" alt="" class="eigth-section-second-content-img-1">
                                <img src="<?php echo e(asset ('assets/images/Home-images/eigth-section/card-2.png  ')); ?>" alt="" class="eigth-section-second-content-img-2">
                                <img src="<?php echo e(asset ('assets/images/Home-images/eigth-section/card-3.png  ')); ?>" alt="" class="eigth-section-second-content-img-3">
                            </div>
...
<?php echo $__env->make('header.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\SysplexUser\Desktop\laravel\example-app\resources\views/pages/homepage.blade.php ENDPATH**/ ?>