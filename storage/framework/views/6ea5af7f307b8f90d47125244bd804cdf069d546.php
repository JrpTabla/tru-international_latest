        ...
        <div class="Page-Body m-auto">
                <div class="Page-Membership-body">
                    <div class="row">
                        ...
                        <div class="col-3 user-card-profile">
                            <div class="user-card-content">
                                <img src="<?php echo e(asset ('assets/images/user/Dashboard-membership/Briefcase.png')); ?>" alt="">
                        ...
                        <div class="col-3 user-card-profile">
                            <div class="user-card-content">
                                <img src="<?php echo e(asset ('assets/images/user/Dashboard-membership/Danger.png')); ?>" alt="">
                        ...
                        <div class="col-3 user-card-profile">
                            <div class="user-card-content">
                                <img src="<?php echo e(asset ('assets/images/user/Dashboard-membership/Unity.png')); ?>" alt="">
                                <div class="d-flex">
...
<?php echo $__env->make('header.user_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\SysplexUser\Desktop\laravel\tru-international\resources\views/pages/user/dashboard.blade.php ENDPATH**/ ?>