...
<div class="main">
  ...
  <section id="rpp-landing-section" class="rpp-landing-section">
    <div class="rpp-landing-section-container row mx-auto">
      <div class="rpp-landing-section-first-div row">
        <div
          class="rpp-landing-section-first-content d-flex col-12 col-xl-6"
        >
          <div class="m-auto">
        ...
        <div
          class="rpp-landing-section-second-content d-flex col-12 col-xl-6"
        >
  ...
  <section id="rpp-second-section" class="rpp-second-section">
    <div class="rpp-second-section-container row mx-auto">
      <div class="rpp-second-section-first-div row">
        ...
        <!-- <div class="rpp-section-second-content d-flex col-12 col-xl-5">
          <div class="m-auto">
            <div class="rpp-second-section-content-img">
              <img src="<?php echo e(asset ('assets/images/RPP-images/second-section/second-section-img.png')); ?>" alt="" width="100%"/>
            </div>
          </div>
        </div> -->
        ...
        <div class="rpp-second-section-third-content row d-flex col-12">
          <div class="col-12 col-md-3 rpp-second-section-graph-1">
          ...
          <div class="col-12 col-md-3 rpp-second-section-graph-2">
          ...
          <div class="col-12 col-md-3 rpp-second-section-graph-3">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="36" viewBox="0 0 32 36" fill="none">
              <path opacity="0.48" d="M26.0234 0.75H6.07189C3.13269 0.75 0.75 3.13269 0.75 6.07189V29.9281C0.75 32.8673 3.13269 35.25 6.07189 35.25H26.0234C28.9626 35.25 31.3453 32.8673 31.3453 29.9281V6.07189C31.3453 3.13269 28.9626 0.75 26.0234 0.75Z" fill="white"/>
  ...
  <section id="rpp-third-section" class="rpp-third-section">
    <div class="rpp-third-section-container row mx-auto">
      <div class="rpp-third-section-first-div row">
        ...
        <div
          class="rpp-third-section-second-content d-flex col-12 col-xl-6"
        >
          <div class="mx-auto">
  ...
  <section id="rpp-sixth-section" class="rpp-sixth-section">
    <div class="rpp-sixth-section-title text-center mx-auto">
    ...
    <div class="rpp-section-container row mx-auto">
      ...
      <div class="rpp-sixth-section-show-more text-center mx-auto">
        Show more
      </div>
    </div>
  </section>
...
<?php echo $__env->make('header.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\SysplexUser\Desktop\laravel\tru-international\resources\views/pages/risk-protection-program.blade.php ENDPATH**/ ?>