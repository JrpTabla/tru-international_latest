...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset ('assets/css/user/user_header.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset ('assets/css/user/user_update.css')); ?>">
    ...
    <div class="side-nav-div">
        <div class="side-navbar-nav-link-div">
            ...
            <a class="side-navbar-nav-link" href="/dashboard">
                <div class="d-flex side-nav-content">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 16 18" fill="none" class="side-nav-svg my-auto">
            ...
            <a class="side-navbar-nav-link">
                <div class="d-flex side-nav-content">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 16 20" fill="none" class="side-nav-svg my-auto">
            ...
            <a class="side-navbar-nav-link">
                <div class="d-flex side-nav-content">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 20 20" fill="none" class="side-nav-svg my-auto">
            ...
            <a class="side-navbar-nav-link">
                <div class="d-flex side-nav-content">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 18 18" fill="none" class="my-auto">
            ...
            <a class="side-navbar-nav-link">
                <div class="d-flex side-nav-content">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 19 16" fill="none" class="my-auto">
            ...
            <a class="side-navbar-nav-link">
                <div class="d-flex side-nav-content">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 23 23" class="my-auto">
            ...
            <div class="dropdown">
                <a class="side-navbar-nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <div class="d-flex side-nav-content">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="my-auto"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M9 12C9 12.5523 8.55228 13 8 13C7.44772 13 7 12.5523 7 12C7 11.4477 7.44772 11 8 11C8.55228 11 9 11.4477 9 12Z" fill="#000"></path> <path d="M13 12C13 12.5523 12.5523 13 12 13C11.4477 13 11 12.5523 11 12C11 11.4477 11.4477 11 12 11C12.5523 11 13 11.4477 13 12Z" fill="#000"></path> <path d="M16 13C16.5523 13 17 12.5523 17 12C17 11.4477 16.5523 11 16 11C15.4477 11 15 11.4477 15 12C15 12.5523 15.4477 13 16 13Z" fill="#000"></path> <path fill-rule="evenodd" clip-rule="evenodd" d="M12 1.25C6.06294 1.25 1.25 6.06294 1.25 12C1.25 17.9371 6.06294 22.75 12 22.75C17.9371 22.75 22.75 17.9371 22.75 12C22.75 6.06294 17.9371 1.25 12 1.25ZM2.75 12C2.75 6.89137 6.89137 2.75 12 2.75C17.1086 2.75 21.25 6.89137 21.25 12C21.25 17.1086 17.1086 21.25 12 21.25C6.89137 21.25 2.75 17.1086 2.75 12Z" fill="#000"></path> </g></svg>
                        <div class="side-navbar-nav-link-text-div d-flex">
                            <div class="side-navbar-nav-link-text my-auto">
                                More
                            </div>
                ...
                <ul class="dropdown-menu">
                    <div class="side-navbar-nav-link-div">
                        <a class="side-navbar-nav-link" onclick="logout()">
                            <div class="d-flex side-nav-content">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 16 16" fill="none" class="my-auto">
                        ...
                        <a class="side-navbar-nav-link">
                            <div class="d-flex side-nav-content">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 16 16" class="my-auto">
                        ...
                        <a class="side-navbar-nav-link">
                            <div class="d-flex side-nav-content">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 13 16" fill="none" class="my-auto">
                        ...
                        <a class="side-navbar-nav-link" href="/account-settings">
                            <div class="d-flex side-nav-content">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 16 16" fill="none" class="my-auto">
...
</html><?php /**PATH C:\Users\Admin-IT\Desktop\tru-international\tru-international_latest\resources\views/header/user_header.blade.php ENDPATH**/ ?>