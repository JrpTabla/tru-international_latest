    ...
    <div class="rpp-section-container row mx-auto">
      ...
      >
        ...
        >
          ...
          <div class="rpp-fourth-section-card-title">Active Membership</div>
          <div class="rpp-fourth-section-card-description">
            You must be a TRU member to be covered with the Risk Protection
            Plan. Once registered, you can apply for the coverage of your
            qualified losses twice yearly and enjoy additional security
        ...
        >
          ...
          <div class="rpp-fourth-section-card-description">
            With the Risk Protection Plan, you can regain your investment
            losses and confidently move forward. Tell us your case, and our
            Dispute Resolution System (DRS) Team will resolve it for you.
          </div>
        </div>
        <div
          class="rpp-section-first-content d-flex col-12 col-xl-4"
        ...
        >
          ...
          <div class="rpp-fourth-section-card-description">
            After successfully filing, expect to receive your claim after
            the standard investigation and approval protocol. Our legal team
            will keep you updated and provide a detailed resolution
            timeline.
          </div>
        </div>
      </div>
...
<?php echo $__env->make('header.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\James for Zuitt\OneDrive\Desktop\Clone\tru-international_latest\resources\views/pages/risk-protection-program.blade.php ENDPATH**/ ?>