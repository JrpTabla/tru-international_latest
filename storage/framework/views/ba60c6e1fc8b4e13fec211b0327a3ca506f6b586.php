                ...
                <div class="ug-landing-section-second-content d-flex col-12 col-xl-6">
                    <div class="mx-auto mt-auto">  
                        <div class="ug-landing-section-first-content-img">
                            <img src="<?php echo e(asset ('assets/images/UG-images/landing-img.png')); ?>" alt="" style="width: 100%;">
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('header.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\SysplexUser\Desktop\laravel\example-app\resources\views/pages/unity-gains.blade.php ENDPATH**/ ?>