    ...
    <section id="ct-fourth-section" class="ct-fourth-section" style="overflow: hidden">
        ...
        <div class="ct-fourth-section-container">
    ...
    <section id="ct-sixth-section" class="ct-sixth-section">
        <div class="ct-sixth-section-title text-center mx-auto">You may also be asking…
</div>
        <div class="ct-section-container row mx-auto">
...
<?php echo $__env->make('header.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\SysplexUser\Desktop\laravel\tru-international\resources\views/pages/communitrade.blade.php ENDPATH**/ ?>