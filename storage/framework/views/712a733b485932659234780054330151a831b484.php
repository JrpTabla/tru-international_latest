...
<div class="container-fluid div-content">
    <div class="row my-auto">
        <div class="col-6 d-flex div-first-content">
            <div class="m-auto">
                <img src="<?php echo e(asset ('assets/images/auth/register/picture.png')); ?>" alt="">
                <div class="div-title">
...
<?php echo $__env->make('header.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin-IT\Desktop\tru-international\tru-international_latest\resources\views/auth/register.blade.php ENDPATH**/ ?>